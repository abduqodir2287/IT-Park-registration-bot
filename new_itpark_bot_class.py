...
class New_itpark_bot_helperDB:
    ...
    def add_item(self, fullname, phoneNumber, course, birthday, jinsi, pasport):

        sql = f"""INSERT INTO "{self.tabname}" (fullname, phoneNumber, course, birthday, jinsi, pasport)
            VALUES (?, ?, ?, ?, ?, ?);"""
        data = (fullname, phoneNumber, course, birthday, jinsi, pasport)
